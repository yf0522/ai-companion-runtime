...
- Set `EXPECTED_MIGRATION_HEADS=b0c1d2e3f4a5` and verify `alembic heads` returns that single head.
...
2. Run `alembic upgrade b0c1d2e3f4a5` as a one-off migration job.
