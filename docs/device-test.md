...
Because the firmware project and serial logs are not bundled in this repository, this repo treats that work as historical reference rather than fully reproduced hardware verification.
