...
TOOL_RULES: dict[str, dict] = {
    ...
    "contact": {
        "patterns": [
            r"^(?:请|麻烦|帮我|能不能|可以)?(?:联系|通知|告诉).{0,4}(?:家人|家属|孩子|女儿|儿子)",
            r"^(?:请|麻烦|帮我|让|我想让|想让|希望|我希望|需要|我需要|能不能让|可以让).{0,6}"
            r"(?:家人|家属|孩子|女儿|儿子).{0,12}"
            r"(?:联系我|给我打电话|知道我需要帮助|来帮我|帮帮我|来看看我)",
            r"^(?:(?:我希望|我想).{0,4}你|(?:请|麻烦).{0,4}(?:你)?)"
            r"(?:联系|通知|告诉).{0,4}"
            r"(?:家人|家属|孩子|女儿|儿子)",
        ],
        "negative": [
            r"(?:不用|不要|不需要|不想).{0,12}(?:联系|通知|告诉|让).{0,8}(?:家人|家属|孩子|女儿|儿子)",
            r"(?:不用|不要|不需要|不想).{0,12}(?:家人|家属|孩子|女儿|儿子).{0,8}(?:知道|联系|帮忙)",
            r"(?:联系|通知|告诉).{0,6}(?:家人|家属|孩子|女儿|儿子).{0,4}(?:了吗|了没|过吗|没有)$",
        ],
    },
    "caretask": {
        "patterns": [
            ...
            r"我的.*任务", r"待办.*药",
            r"今天.*(?:药|任务|提醒|事项|安排)", r"今日.*(?:事项|任务)",
            r"我今天需要做什么", r"看看今天的安排",
        ],
